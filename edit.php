...
if(isset($_POST['adults'])&&isset($_POST['k3'])&&isset($_POST['k1'])&&isset($_POST['k2']))
	$total=$adults+$k1+$k2+$k3+1;
if(isset($_POST['cws'])&&isset($_POST['name']))
	mysql_query("UPDATE arrived_list SET adults='$adults',k1='$k1',k2='$k2',k3='$k3',souvenir='$souvenir' WHERE cws ='$cws' ")or die(null);
?>
...
<script type="text/javascript" src="View/edit_view.js"> </script>
</head>
<body>
<div id="header">
...
<h1 class="span4">Edit Registered People</h1>
